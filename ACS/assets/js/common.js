...
(function (FECommon) {
	...
	var widget = {
		init: function () {
			...
			this.fn_idxList5Swiper();
			this.fn_idxList6Swiper();
			this.fn_magnific();
			// this.fn_marquee();
			// this.fn_lazyload();
			this.fn_aos();
				...
				var idxList4Swiper = new Swiper('.idxList4SwiperJs', {
					...
					,on:{
						...
						,slideChangeTransitionStart: function(){
							$slides.eq(this.previousIndex).find('.ytWrap').html('<div class="ytPlayer" data-id="'+videoId[this.previousIndex]+'" data-title="'+videoTitle[this.previousIndex]+'"></div>');
		...
		,fn_idxList5Swiper:function(){
			//精選內容
			if ($('.idxList5SwiperJs').length) {
				var sectionTitle = $('.idxFeatured h2').text();
				var idxList5Swiper = new Swiper('.idxList5SwiperJs', {
					pagination: {
						el: '.idxList5SwiperPageJs'
						,clickable:true
						,renderBullet: function (index, className) {
							return '<span class="' + className + '"><i>第'+ (index+1)+'組'+sectionTitle+'</i></span>';
						}
					...
					,navigation: {
						nextEl: '.idxList5SwiperNextBtnJs'
						,prevEl: '.idxList5SwiperPrevBtnJs'
					}
					// ,loop: true
					,observer: true
					,observeParents: true
				...
				function slideAlignCenter(){
					if($('.idxList5SwiperPrevBtnJs').hasClass('swiper-button-lock')){
						$('.idxList5SwiperJs .swiper-wrapper').css('justify-content','center');
					}else{
						$('.idxList5SwiperJs .swiper-wrapper').css('justify-content','');
					}
				}
			}
		}
		,fn_idxList6Swiper:function(){
			//相關連結
			if ($('.idxList6SwiperJs').length) {
				var sectionTitle = $('.idxLinks h2').text();
				var idxList6Swiper = new Swiper('.idxList6SwiperJs', {
					pagination: {
						el: '.idxList6SwiperPageJs'
						,clickable:true
						,renderBullet: function (index, className) {
							return '<span class="' + className + '"><i>第'+ (index+1)+'組'+sectionTitle+'</i></span>';
						}
					...
					,navigation: {
						nextEl: '.idxList6SwiperNextBtnJs'
						,prevEl: '.idxList6SwiperPrevBtnJs'
					}
					// ,loop: true
					,observer: true
					,observeParents: true
				...
				function slideAlignCenter(){
					if($('.idxList6SwiperPrevBtnJs').hasClass('swiper-button-lock')){
						$('.idxList6SwiperJs .swiper-wrapper').css('justify-content','center');
					}else{
						$('.idxList6SwiperJs .swiper-wrapper').css('justify-content','');
					}
				}
			}
		}
